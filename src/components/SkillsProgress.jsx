...
const skills = [
  { name: 'Product Strategy', level: 92, color: 'from-cyan-400 to-cyan-600' },
  { name: 'Growth & Experimentation', level: 90, color: 'from-blue-400 to-blue-600' },
  { name: 'Data Analytics & SQL', level: 88, color: 'from-teal-400 to-teal-600' },
  { name: 'User Research', level: 87, color: 'from-purple-400 to-purple-600' },
  { name: 'A/B Testing', level: 85, color: 'from-green-400 to-green-600' },
  { name: 'Roadmapping & Prioritization', level: 90, color: 'from-indigo-400 to-indigo-600' },
  { name: 'Stakeholder Management', level: 89, color: 'from-orange-400 to-orange-600' },
  { name: 'Agile Delivery', level: 86, color: 'from-pink-400 to-pink-600' },
];
