...
const ProjectsShowcase = () => {
  ...
  return (
    <section id="projects" className="relative w-full py-4 sm:py-8 bg-transparent overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 mt-0 sm:mt-12">
        ...
        >
          ...
          <motion.p 
            ...
            transition={{ duration: 0.3 }}
          >
            Explore a selection of fintech products and growth initiatives I've shipped.
            Each represents real-world impact driven by user research, data, and cross-functional execution.
          </motion.p>
        </motion.div>
