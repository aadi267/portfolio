...
const experiences = [
  {
    ...
    current: true,
    points: [
      "Built a real-time Redash monitoring dashboard for IDFC Bank deposit flows tracking API success/failure rates, settlement timelines, and latency — supporting 300+ daily transactions and driving deposit conversion from 14% to 25%.",
      "Owned the end-to-end withdrawal experience, optimizing settlement timelines and reducing the withdrawal cycle from T+3 to T+2.",
      "Built and enhanced the Customer Support dashboard and in-app flows, reducing CS dependency by 50% through self-serve resolution.",
    ]
  },
  {
    ...
    points: [
      "Digital Gold: Partnered with SafeGold to scale digital gold investments, driving a 90% increase in investment value within 6 months and converting 35% of non-serious investors into active ones.",
      "Loan Against Mutual Funds (LAMF): Ran user research, optimized the loan journey, and reduced thresholds — delivering 2x daily disbursals and a 50% revenue uplift.",
      "Revamped support with an AI chatbot and telephone assistance, improving CSAT by 20% and cutting resolution time by 30%.",
      "FD & MF Marketplace: Launched the FD marketplace with Blostom, offering 25+ FDs across multiple banks.",
    ]
  },
  {
    ...
    points: [
      "Drove ₹4,500 Cr annual GTV by leading the digital transformation of Axis Mutual Funds, redesigning folio and investment journeys with a customer-first approach.",
      "Built the MVP for the ONDC Buyer App, projected to generate ₹10–15 Cr GTV/month.",
      "Scaled the Credit Card Upgrade Journey for a 10M+ customer base and designed the NRI & Mariners onboarding journey, onboarding 104K+ users.",
      "Boosted user engagement by 30% through data-driven prioritization and iterative Agile delivery.",
    ]
  },
  {
...
const Experience = () => {
  ...
  return (
    <section id="work" ref={containerRef} className="relative py-8 sm:py-16 px-4 min-h-screen z-10">
      {/* Enhanced background */}
      <motion.div 
