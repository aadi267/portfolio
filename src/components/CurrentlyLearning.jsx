  ...
  const learningItems = [
    {
      ...
      description: 'Leveraging AI tools and agents to accelerate product workflows',
      progress: 70,
      resources: ['LLMs', 'AI Agents', 'Automation'],
    },
    {
      title: 'Advanced Product Analytics',
      description: 'Deepening data-driven decision making and experimentation',
      progress: 65,
      resources: ['SQL', 'Amplitude', 'Experimentation'],
    },
    {
      title: 'Growth Product Management',
      description: 'Frameworks for retention, activation, and monetization',
      progress: 55,
      resources: ['Funnels', 'Retention', 'Monetization'],
    },
    {
      title: 'System Design for PMs',
      description: 'Understanding technical architecture and trade-offs',
      progress: 45,
      resources: ['APIs', 'Architecture', 'Scalability'],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-slate-400 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto">
            Staying ahead with the latest in product management, growth, and AI
          </p>
        </motion.div>
